...
<div class="card-body p-2">
		...
		<hr>
				 ...
				 <label for="inputAddress" class="form-label"></label>
								...
								<input type="text" class="form-control" name="prod_name" placeholder="Nome" rows="1"></input>
									</div>

                                    <div class="col-6">
										<label for="inputAddress" class="form-label"></label>
										<input type="email" class="form-control" name="meila" placeholder="Email" rows="1"></input>
									</div>
                                    <div class="col-6">
										<label for="inputAddress" class="form-label"></label>
									...
									<div class="col-12">
										<button type="submit" class="btn btn-light px-5">Add Usuário</button>
									</div>
