...
<div class="card-body p-5">
        ...
        <div class="col-md-7">
			<label for="inputState" class="form-label">Tipo de fornecedores</label>
			...
			<select id="inputState" class="form-select" name="state" value="{{$fornecedor->state}}">
			<option selected=""></option>
		
			@foreach( $estados as $estado )
				
				<option value="{{ $estado->st_code }}">{{ $estado->st_name }}</option>
			@endforeach		
			</select>
		</div>
			<div class="col-md-6">
        ...
        <a href="" class="btn btn-success float-right">Nova Conta Bancária</a>
                                ...
                                <div class="col-3">
										...
										<input type="text" class="form-control" name="b_favorecido" placeholder="Favorecido" rows="1" value="{{$fornecedor->b_favorecido}}"></input>
									</div>
                                    <div class="col-2">
										<label for="inputAddress" class="form-label"></label>
										<input type="text" class="form-control" name="b_cpf" placeholder="CPF ou CNPJ" rows="1" value="{{$fornecedor->b_cpf}}"></input>
									</div>
                                    <div class="col-3">
										<label for="inputAddress" class="form-label"></label>
										<input type="text" class="form-control" name="bbank" placeholder="Banco" rows="1" value="{{$fornecedor->bbank}}"></input>
									</div>
                                    <div class="col-3">
										<label for="inputAddress" class="form-label"></label>
										<input type="text" class="form-control" name="agency" placeholder="Agência" rows="1" value="{{$fornecedor->agency}}"></input>
									</div>
                                    <div class="col-1">
										<label for="inputAddress" class="form-label"></label>
										<input type="text" class="form-control" name="digit" placeholder="Dígito" rows="1" value="{{$fornecedor->digit}}"></input>
									</div>
                                    <div class="col-2">
										<label for="inputAddress" class="form-label"></label>
										<input type="text" class="form-control" name="amount" placeholder="Conta" rows="1" value="{{$fornecedor->amount}}"></input>
									</div>
                                    <div class="col-1">
										<label for="inputAddress" class="form-label"></label>
										<input type="text" class="form-control" name="digit_amount" placeholder="Dígito" rows="1" value="{{$fornecedor->digit_amount}}"></input>
									</div>
                                    ...
                                    <div class="col-2">
										<label for="inputAddress" class="form-label"></label>
										<textarea type="text" class="form-control" id="inputAddress" placeholder="Nota" rows="1" value="{{$fornecedor->Nota}}"></textarea>
									</div>
									<div class="col-12">
										<label for="inputAddress" class="form-label"></label>
