				...
				<nav class="navbar navbar-expand">
								...
								<div class="dropdown-menu dropdown-menu-end">
									<a href="javascript:;">
										<div class="msg-header">
											...
											<p class="msg-header-clear ms-auto">Marca tudo como lido</p>
										</div>
									</a>
								...
								<div class="dropdown-menu dropdown-menu-end">
									<a href="javascript:;">
										<div class="msg-header">
											...
											<p class="msg-header-clear ms-auto">Marcar todos como lido</p>
										</div>
									</a>
					...
					<div class="user-box dropdown">
						<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							<img src="{{ asset('assets/images/avatars/alfredo.jpg') }}" class="user-img" alt="user avatar">
							<div class="user-info ps-3">
								<p class="user-name mb-0">{{Auth::user()->name}}</p>
								<p class="designattion mb-0">Master</p>
							</div>
						</a>
						<ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <i class='bx bx-log-out-circle'></i><span>Sair</span></a>
							</li>
						</ul>
					</div>
				</nav>
